...
@section('title', 'Quiz pajak')

@section('content')
<div style="position: relative; text-align: center; ">
    <img src="{{ asset('/img/bgquiz.jpg') }}" class="w-full" alt="...">
    <div
        style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 50px; color: white; font-weight: bold;">
        Kuis
    </div>
    <div
        style="position: absolute; top: 64%; left: 50%; transform: translate(-50%, -50%); font-size: 25px; font-style: Inter; color: white; font-weight: lighter;">
        Beranda // Kuis PPh
    </div>
</div>
...
<div style="position: relative; text-align: center;">
    ...
    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white text-center rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-auto" 
    style="background: linear-gradient(180deg, #4FA2ED 0%, #289C5E 100%);">Lihat
        <svg class="w-4 h-4 ml-1 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
            </svg>
        </a>
